...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/movchinnikov/Desktop/lolcode/Repositories/RussainRoulette'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/movchinnikov/Desktop/lolcode/Repositories/RussainRoulette/bin/deactivate.nu'
